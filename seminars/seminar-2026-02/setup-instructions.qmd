...
::::: columns
::: {.column width="50%"}
- Scroll all the down to the "Get Copilot from an organization" section
  and click the "**Request access**" button from worldbank organization.
...
- Sending an email to
  ...
  **GitHub username** and a **brief reason for requesting access**. Copy
  manager or team lead for approval.
:::
...
organization. Your usage statistics will looks like this:
...
1.  Ask you manager for a permission to use a budget code for overuse of
...
See GitHub Setup [@github-setup] instructions below if you don't have an
account or haven't linked it to the WB organization. To connect GitHub
to Positron:
